...
document.addEventListener('DOMContentLoaded', function () {
    ...
    loginForm.addEventListener('submit', function (event) {
        var emailInput = document.querySelector('.login-form input[type="text"]');
    ...
    signupForm.addEventListener('submit', function (event) {
        var emailInput = document.querySelector('.signup-form input[type="text"]');
        var passwordInput = document.querySelector('.signup-form input[type="password"]');
